...
**다음 운영 작업 (J3):** Preview에 `VITE_SUPABASE_MANUAL_MIRROR_ENABLED=true` → `/admin?module=journal`에서 A/B/C 「Supabase 업무일지 저장」 검증.
...
J3 Preview 미러 파일럿 ░░░░░░░░░░  다음 ←
J4 신선도 UI           ░░░░░░░░░░
J5~J7 가져오기·자동화  ░░░░░░░░░░

(인프라: journal_snapshots DDL ✅ · env ✅ · admin-session API ✅)
```
