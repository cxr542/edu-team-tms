...
**다음 운영 작업 (J3):** Preview `MANUAL_MIRROR=true`는 설정됨. Supabase SQL Editor에서 [`j3-grant-service-role-journal.sql`](../supabase/j3-grant-service-role-journal.sql) 실행 후 Preview `/admin?module=journal`에서 A/B/C 저장 검증.
...
J3 Preview 미러 파일럿 ████░░░░░░  env·배포 ✅ · GRANT 대기 ←
J4 신선도 UI           ░░░░░░░░░░
J5~J7 가져오기·자동화  ░░░░░░░░░░

(인프라: journal_snapshots DDL ✅ · env ✅ · admin-session API ✅ · Preview MANUAL_MIRROR ✅)
```
...
| 단계 | 작업 | 담당 | 완료 기준 |
|------|------|------|-----------|
| **J3** | Preview `MANUAL_MIRROR=true` + service_role GRANT | 🔄 env·Preview 배포 ✅ / DB GRANT 대기 |
