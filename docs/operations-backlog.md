...
**J7a 완료:** Preview 미러 도구 표시 중 `GET /api/journal-snapshots`를 ~30s·focus로 폴링해 「원격이 더 최신」만 자동 갱신. 자동 가져오기·Blob 변경 없음. anon Realtime은 admin-session 구조상 보류. 다음은 **J7**(Realtime·Blob 축소).
